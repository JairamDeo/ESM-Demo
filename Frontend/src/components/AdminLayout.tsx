...
import {
  ...
  BarChart3, AlertTriangle, ClipboardList, Menu, X, Shield, ListTree, Megaphone, Network, FileCheck2
} from "lucide-react";
...
const ALL_NAV = [
  ...
  { icon: FileCheck2,      label: "Required Docs", path: "/required-documents", perm: "viewRequiredDocuments" },
