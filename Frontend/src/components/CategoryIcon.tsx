...
export function CategoryIcon({
  ...
  return (
    ...
    >
      {remote ? (
        <img src={remote} alt="" className={`${sizeClasses.img} object-contain`} />
      ) : (
        <img
          src={fallback.icon}
          alt=""
          className={`${sizeClasses.img} object-contain dark:invert dark:opacity-90`}
        />
      )}
    </div>
  );
