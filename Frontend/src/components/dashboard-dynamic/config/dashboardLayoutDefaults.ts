...
export const FRONTEND_LAYOUT_DEFAULTS: DashboardWidgetConfig[] = [
  ...
  { id: "status-breakdown", widgetKey: "status-breakdown", chartType: "bar", x: 0, y: 13, w: 4, h: 5, minW: 3, minH: 4 },
  ...
  { id: "by-priority", widgetKey: "by-priority", chartType: "bar", x: 4, y: 18, w: 4, h: 5, minW: 3, minH: 4 },
  { id: "by-submission-source", widgetKey: "by-submission-source", chartType: "bar", x: 8, y: 18, w: 4, h: 5, minW: 3, minH: 4 },
