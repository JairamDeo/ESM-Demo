...
export function StatusBreakdownWidget({ chartType }: { chartType: string }) {
  ...
  if (pieData.length === 0) {
    return <div className="h-full flex items-center justify-center text-muted-foreground text-sm">No grievance status data</div>;
  }
