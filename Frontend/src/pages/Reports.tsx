        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none px-3 py-2 pr-10 text-sm bg-secondary/50 border border-border text-foreground rounded-lg outline-none hover:bg-secondary/80 cursor-pointer"
            >
