  ...
  return (
    <div className="flex flex-col min-h-screen bg-background max-w-md mx-auto px-6">
      ...
      <div className="flex-1">
        <h1 className="text-2xl font-semi-bold text-foreground mb-1">Login</h1>
        ...
        <div className="space-y-2 mb-2">
          ...
          <div className="flex items-center gap-3 bg-[#23222A] rounded-xl px-4 py-3.5 border border-border focus-within:border-primary transition-colors">
            <Phone className="w-4 h-4 text-muted-foreground/101 shrink-0" />
            <span className="text-muted-foreground text-[#CBD5E1] text-sm shrink-0  font-thin">+91</span>
          ...
          <p className="text-xs font-thin  text-[#FFFFFF] text-muted-foreground px-2 opacity-80 ">We'll send a 4-digit verification code</p>
        </div>
        <button onClick={handleRegister} disabled={phone.length < 10 || loading} className="w-full shadow-[0_4px_12px_rgba(23,84,207,0.2)]  mt-6 bg-[#826CF3] text-primary-foreground font-semibold py-3.5 rounded-xl text-sm transition-all hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2">
