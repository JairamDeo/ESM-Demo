...
const seed = async () => {
  ...
  const caseTypesData = [
    ...
    { id: "casetype2",  name: "Update Aadhaar & PAN",       description: "Identity document updates",     totalCases: 92,  pendingCases: 15, resolvedCases: 77,  category: categoryByName["Identity & Personal"] },
    { id: "casetype3",  name: "Update Mobile & Email",      description: "Contact detail updates",        totalCases: 68,  pendingCases: 5,  resolvedCases: 63,  category: categoryByName["Identity & Personal"] },
    { id: "casetype4",  name: "Update Address",             description: "Residential address changes",   totalCases: 54,  pendingCases: 7,  resolvedCases: 47,  category: categoryByName["Identity & Personal"] },
    { id: "casetype5",  name: "Resolve Pension Issues",     description: "Pension queries & corrections", totalCases: 156, pendingCases: 42, resolvedCases: 114, category: categoryByName["Pension & Financial"] },
    { id: "casetype6",  name: "Stop FMA",                   description: "Fixed Medical Allowance",       totalCases: 31,  pendingCases: 4,  resolvedCases: 27,  category: categoryByName["Pension & Financial"] },
    { id: "casetype7",  name: "Monthly Pay Slip",           description: "Download & view slips",         totalCases: 78,  pendingCases: 3,  resolvedCases: 75,  category: categoryByName["Pension & Financial"] },
    { id: "casetype8",  name: "Pension Payment Order",      description: "PPO access & updates",          totalCases: 62,  pendingCases: 11, resolvedCases: 51,  category: categoryByName["Pension & Financial"] },
    { id: "casetype9",  name: "Add Nominee",                description: "Nominee registration",          totalCases: 43,  pendingCases: 6,  resolvedCases: 37,  category: categoryByName["Family Details"] },
    { id: "casetype10", name: "Update DOB of Spouse",       description: "Date of birth correction",      totalCases: 29,  pendingCases: 4,  resolvedCases: 25,  category: categoryByName["Family Details"] },
    { id: "casetype11", name: "Update Spouse Details",      description: "Name, PAN, Aadhaar, Email",     totalCases: 38,  pendingCases: 5,  resolvedCases: 33,  category: categoryByName["Family Details"] },
    { id: "casetype12", name: "Add/Update Family Details",  description: "Family composition records",    totalCases: 47,  pendingCases: 9,  resolvedCases: 38,  category: categoryByName["Family Details"] },
    { id: "casetype13", name: "Death Intimation",           description: "ESM & Dependents",               totalCases: 45,  pendingCases: 8,  resolvedCases: 37,  category: categoryByName["Requests & Tracking"] },
